...
"""
This script runs at the start-up of the VM, using the input files associated with the machine to run an Open Malaria
simulation and upload the results to the cloud.
"""
